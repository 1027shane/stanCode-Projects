"""
File: ds.py(DataStructure)
Name: Jerry Liao
-------------------------
This file shows all the data structures, including:
(1)Tree
(2)ListNode
(3)PriorityQueue with enqueue, dequeue, traversal, and length methods.
"""
...
class PriorityQueue:
    ...
    def enqueue(self, element):
        """
        User call this method to ADD(加入) element to self.pq sorted by element[1]
    ...
    def dequeue(self):
        """
        Users call this method to GET(取出) the ListNode with lowest priority
