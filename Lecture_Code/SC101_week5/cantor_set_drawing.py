...
Name: Shane Liu
-------------------------
This program draws as fractal named cantor set on GWindow,
calling the recursive function cantor_set.
Students will learn another way of controlling base case using a parameter 'LEVEL'.
"""
