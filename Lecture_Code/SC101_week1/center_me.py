...
Name: Shane Liu
-------------------------
This program shows how to center a GRect on windows,
where the width and the height are randomly chosen.
"""
...
def main():
    ...
    rect.filled = True
    rect.fill_color = 'magenta'  # filled
    rect.color = 'magenta'  # outline
    window.add(rect)
